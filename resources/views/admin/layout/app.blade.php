...
<head>
  ...
  <title>Admin Dashboard &mdash; Nang</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ asset('admin/node_modules/bootstrap-daterangepicker/daterangepicker.css') }}">
  <link rel="stylesheet" href="{{ asset('admin/node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
...
<body>
  <div id="app">
   ...
   <!-- JS Libraies -->
   <script src="{{ asset('admin/node_modules/cleave.js/dist/cleave.min.js') }}"></script>
   <script src="{{ asset('admin/node_modules/cleave.js/dist/addons/cleave-phone.us.js') }}"></script>
   ...
   <script src="{{ asset('admin/node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
   <script src="{{ asset('admin/node_modules/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}"></script>
