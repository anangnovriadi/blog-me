    ...
    <div class="section">
        <div class="container">
            <div class="text-center mt-8">
                ...
                <p>June 18, 2018 in <a href="#">Products</a></p>
            </div>
            <div class="text-center my-8">
                <img class="rounded-md" src="{{ asset('web/assets/img/thumb/5.jpg') }}" alt="...">
            </div>
            <div class="row">
            ...
            <div class="text-center my-6">
                <img class="rounded-md" src="{{ asset('web//assets/img/bg/11.jpg') }}" alt="...">
            </div>
            <div class="row">
                <div class="col-lg-8 mx-auto">
